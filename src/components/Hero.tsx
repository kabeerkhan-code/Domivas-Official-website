      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-32 relative z-10">
        <div className="space-y-16">
          ...
          <div className="text-center space-y-8">
            <h1 className="text-6xl lg:text-8xl xl:text-9xl font-black text-gray-900 leading-tight lg:leading-tight xl:leading-tight tracking-tight max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <button 
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-8 sm:px-12 md:px-16 py-6 sm:py-8 rounded-full hover:shadow-2xl transition-all duration-500 font-black text-lg sm:text-xl md:text-2xl uppercase tracking-wide hover:scale-110 hover:-translate-y-2 shadow-lg border-4 border-red-700 w-full sm:w-auto max-w-full text-center"
            >
