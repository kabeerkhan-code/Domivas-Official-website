  ...
  return (
    <section id="demo" className="py-32 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        {/* Dominant Demo CTA Section */}
        <div className="mb-20">
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl p-16 text-center shadow-2xl relative overflow-hidden">
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-10 left-10 w-32 h-32 border-2 border-white rotate-45"></div>
              <div className="absolute bottom-10 right-10 w-24 h-24 border-2 border-white rounded-full"></div>
              <div className="absolute top-1/2 right-20 w-16 h-16 bg-white rotate-12"></div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                Don't just imagine it. Experience the exact quality, design, and functionality we deliver for dental clinics.
              </p>
